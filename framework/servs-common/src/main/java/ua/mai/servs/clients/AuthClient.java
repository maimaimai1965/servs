...
@FeignClient(name = "auth", url = "${servs.modules.bbb.url}", configuration = ClientConfig.class)
public interface AuthClient {

    @PostMapping(value = "${servs.modules.bbb.auth-jwt.endpoints}", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
